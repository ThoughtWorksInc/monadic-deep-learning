...
\documentclass[acmsmall,10pt,review,screen]{acmart}
...
\begin{abstract}
The Java and Scala community had built a very successful big data ecosystem.
...
Until 2017, all deep learning frameworks in statically typed languages do not provide the expressive power of traditional frameworks.
...
\begin{itemize}
  \item We discovered a novel approach to perform automatic differentiation in reverse mode for statically typed functions that contain multiple \glspl{trainable variable}, and can interoperate freely with the metalanguage, just like pytorch.
...
Together of these features, users of DeepLearning.scala are able to create complex neural networks in an intuitive and concise way, and still maintain type safety.
\end{abstract}
