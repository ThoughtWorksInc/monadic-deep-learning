...
\begin{table}[htbp]
  ...
  \begin{tabular}{lll}
    \toprule
    non-trainable value & \gls{trainable variable} & \gls{differentiable expression} \\ \midrule
    Double & DoubleWeight & DoubleLayer \\
    Float & FloatWeight & FloatLayer \\
    INDArray & INDArrayWeight & INDArrayLayer \\
    \bottomrule
  \end{tabular}
\end{table}
