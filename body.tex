...
The benchmark result is shown in Table~\ref{The benchmark result when unmatched fine-grained classifier is skipped} and Table~\ref{The benchmark result when no fine-grained classifier is skipped} (larger score is better):
...
\begin{table}[htbp]
  ...
  \texttt{number of branches} & \texttt{thread pool size} & \multicolumn{2}{c}{\texttt{Score, ops/s}} \\
  \hline
  \texttt{4} & \texttt{1} & \texttt{ 5.516} & \scriptsize $\pm$ \texttt{0.101}  \\
  \texttt{4} & \texttt{2} & \texttt{ 7.351} & \scriptsize $\pm$ \texttt{0.164}  \\
  \texttt{4} & \texttt{4} & \texttt{ 9.895} & \scriptsize $\pm$ \texttt{0.483}  \\
  \texttt{2} & \texttt{1} & \texttt{ 6.824} & \scriptsize $\pm$ \texttt{0.101}  \\
  \texttt{2} & \texttt{2} & \texttt{ 9.739} & \scriptsize $\pm$ \texttt{0.195}  \\
  \texttt{2} & \texttt{4} & \texttt{11.920} & \scriptsize $\pm$ \texttt{0.480}  \\
  \texttt{1} & \texttt{1} & \texttt{ 7.553} & \scriptsize $\pm$ \texttt{0.104}  \\
  \texttt{1} & \texttt{2} & \texttt{10.269} & \scriptsize $\pm$ \texttt{0.126}  \\
  \texttt{1} & \texttt{4} & \texttt{13.562} & \scriptsize $\pm$ \texttt{0.117}  \\
  \end{tabular}
...
\begin{table}[htbp]
  ...
  \texttt{number of branches} & \texttt{thread pool size} & \multicolumn{2}{c}{\texttt{Score, ops/s}} \\
  \hline
  \texttt{4} & \texttt{1} & \texttt{12.877} & \scriptsize $\pm$ \texttt{0.342}  \\
  \texttt{4} & \texttt{2} & \texttt{14.064} & \scriptsize $\pm$ \texttt{0.378}  \\
  \texttt{4} & \texttt{4} & \texttt{17.189} & \scriptsize $\pm$ \texttt{0.518}  \\
  \texttt{2} & \texttt{1} & \texttt{21.997} & \scriptsize $\pm$ \texttt{0.457}  \\
  \texttt{2} & \texttt{2} & \texttt{25.507} & \scriptsize $\pm$ \texttt{0.495}  \\
  \texttt{2} & \texttt{4} & \texttt{28.921} & \scriptsize $\pm$ \texttt{0.757}  \\
  \texttt{1} & \texttt{1} & \texttt{35.566} & \scriptsize $\pm$ \texttt{0.339}  \\
  \texttt{1} & \texttt{2} & \texttt{37.328} & \scriptsize $\pm$ \texttt{0.909}  \\
  \texttt{1} & \texttt{4} & \texttt{38.630} & \scriptsize $\pm$ \texttt{0.767}  \\
  \end{tabular}
  \caption{The benchmark result when unmatched fine-grained classifier is skipped}
  \label{The benchmark result when unmatched fine-grained classifier is skipped}
\end{table}
