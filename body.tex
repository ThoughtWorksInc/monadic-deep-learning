...
Arithmetic operations between those types are ad hoc polymorphic functions, able to accept heterogeneous types of input.
...
Note that built-in operations like \lstinline{max} and \lstinline{dot} can be used as before, because those built-in operations are polymorphic, too.
