...
The computational graph of \lstinline{computationalTree} is shown in Fig. \ref{tree}. The arrow direction denotes the dependency between expressions, from arrow tail to arrow head.
